...
class OrderServiceTest {
    ...
    @AfterEach
    void tearDown() {
        // 두 테스트를 같이 돌리면 2번째 테스트가 실패함 (데이터 중복이라 그럼) => tearDown 메소드를 작성해야함
        // RepositoryTest 는 해당 작업을 하지 않아도 수행됨 (SpringBootTest 와 DataJpaTest 의 차이)
        // DataJpaTest 의 경우 롤백이 자동으로 수행됨
